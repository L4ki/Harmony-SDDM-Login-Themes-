    ...
    */
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            textColor: "#132e43"
            selectedTextColor: "#132e43"        // The highlighted text color
            selectionColor: "#006A80"           // The text highlight color
            placeholderTextColor:"#006A80"      // When the text field is empty
            background: Rectangle {
                color: "#e4f9fd"
                radius: 2
                                                    //focus   //normal
                border.color: control.activeFocus ? "#006A80" : '#132e43'
                border.width: 1
                implicitWidth: 100
                implicitHeight: 30
            }
    ...
    PlasmaComponents.Button {
        ...
        style: ButtonStyle {
            background: Rectangle {
                border.width: 1
                                                    //focus   //normal
                border.color: control.activeFocus ? "#132e43" : '#006A80'
                radius: 2
                gradient: Gradient {                                      //pressed   //normal
                    GradientStop { position: 0 ; color: control.pressed ? "#132e43" : "#006A80" }
                    GradientStop { position: 1 ; color: control.pressed ? "#006A80" : "#132e43" }
                }
                //implicitWidth: 100
                implicitHeight: 30
            }
